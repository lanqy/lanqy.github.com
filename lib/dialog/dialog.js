...
(function($) {
    ...
    $.dialog.prototype = {
        ...
        _bindEvents: function() { // bind events
            ...
            this.element.find('.cannel').click(function() {
            ...
            if (html) {
				...
				if(this.options.showFooter){
					footer = '<div class="footer">\
											<div class="buttons">\
												<button class="confirm">' + this.options.confirmText + '</button>\
												<button class="cannel">' + this.options.cannelText + '</button>\
											</div>\
										</div>';
				}
